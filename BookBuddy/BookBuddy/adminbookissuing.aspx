<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookissuing.aspx.cs" Inherits="BookBuddy.adminbookissuing" %>
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="input-group">
										...
										<asp:Button for="TextBox1" class="btn btn-dark" ID="Button1" Text="Go" OnClick="Button1_Click" />
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-6">
									<asp:Button ID="Button2" class="btn btn-lg btn-block btn-primary" Text="Issue" OnClick="Button2_Click" />
								</div>
								<div class="col-6">
									<asp:Button ID="Button4" class="btn btn-lg btn-block btn-success" Text="Return" OnClick="Button4_Click" />
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="row">
											<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:BookBuddyConnectionString %>' SelectCommand="SELECT * FROM [book_issue_table]">
											</asp:SqlDataSource>
											<div class="col">
