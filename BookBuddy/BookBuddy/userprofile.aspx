<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="BookBuddy.userprofile" %>
                ...
                <div class="row">
                     <div class="col-8 mx-auto">
                        <center>
                            ...
                            <button type="button" class="btn btn-primary btn btn-primary btn-lg">Update</button>
                                </div>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           ...
                           <asp:Label  class="badge rounded-pill bg-info" ID="Label2" runat="server" Text="Information About Books"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
