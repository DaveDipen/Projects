        	...
        	<td>
        		<table class="table3">
        				...
        				while ($res = mysqli_fetch_array($result)) {
        					...
        					echo "<td align='right' colspan='2'><a href='editProfileA.php?id=$tid' class='link'><i class='bi-pencil-square'></i> Edit </a></td>";    				
        				?>
        			</tr>
                    <tr>
                    	<td>
                    	...
                    	<td>
                    		<input type="text" name="fname" id="fname" value="<?php echo $res['Tailor_Name']; ?>" class="w3-input" disabled>
                    	</td>
                    	<td>
                    		Email:
                    	</td>
                    	<td>
                    		<input type="email" name="mail" id="mail" value="<?php echo $res['Tailor_Email']; ?>" class="w3-input" disabled>
                    	</td>
                    </tr>
                    <tr>
                    	<td>
                    	...
                    	<td>
                    		<input type="number" name="fmono" id="fmono" value="<?php echo $res['Tailor_MobileNo']; ?>" class="w3-input" disabled>
                    	</td>
                    </tr>
                	...
                	echo "<tr>";
                	echo "<td>";
                    echo "<a href='addAddressT.php' class='link'>Add New Address</a>";
                    echo "</td>";
                    echo "</tr>";
        			while ($res = mysqli_fetch_array($result)) {
                    ?>
                    <tr>
                    	...
                    	<td>
                    		<input type="text" name="uname" id="uname" value="<?php echo $res['Tailor_userName']; ?>" class="w3-input" disabled>
                    	</td>
                    	<td align="center" colspan="2">
                    		<a href="changePasswordT.php?id=<?php echo $tid;?>" class="link">Change Password</a>
                    	</td>
                    </tr>                    
        			<?php
                    }
