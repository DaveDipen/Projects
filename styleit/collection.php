		...
		<tr>
			<td>
				<table border = 1 class="table1">
					...
					$result = mysqli_query($con,"SELECT * FROM collection_info JOIN tailor_info on tailor_info.Tailor_id = collection_info.Tailor_id WHERE collection_info.Tailor_id = '$tid';");
