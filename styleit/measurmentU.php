			...
			<td>
				<table border = 1 class="table1">
					...
					<tr align="center">
						...
						<td><?php echo $res['M_Chest']." cm"; ?></td>
						<td><?php echo $res['M_Waist']." cm"; ?></td>
						<td><?php echo $res['M_Sleeve']." cm"; ?></td>
						<td><?php echo $res['M_Shoulder']." cm"; ?></td>
						<td><?php echo $res['M_Neck']." cm"; ?></td>
						<td><?php echo $res['M_Length']." cm"; ?></td>
