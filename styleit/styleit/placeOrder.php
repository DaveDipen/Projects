		...
		<tr>
			<td>
				<table>
					...
					$did = $_GET['id'];
					$result = mysqli_query($con,"SELECT * FROM design_info WHERE Design_id = '$did'");
					...
					<tr>
		        		...
		        		<td class="td">
		        			...
		        			<input type="hidden" name="did" value="<?php echo $res['Design_id'];?>">
                		</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="price" disabled value="<?php echo $res['Design_Price'];?>" class='w3-input'>
							<input type="hidden" name="price1" value="<?php echo $res['Design_Price'];?>" class='w3-input'>
						</td>
					</tr>
				<?php
			}
...
if (isset($_POST['place'])) {
    ...
    $record = "INSERT INTO order_info (U_id,M_id,Tailor_id,Design_id,Order_Cost,Order_Status) VALUES('$uid','$mid','$tid','$did','$price','Pending')";
