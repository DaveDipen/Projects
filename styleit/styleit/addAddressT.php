            ...
            <td>
                <table class="table3">
                    ...
                    <tr>    
                        ...
                        <td>
                            <input type="text" name="zip" id="zip" maxlength="6" pattern="[0-9]{6}" placeholder="380001" class="w3-input">
                        </td>                       
...
if (isset($_POST['add'])) {
    ...
    $record = "INSERT INTO `address_info`(`Tailor_id`, `Address_City`, `Address_State`, `Address_Street`, `Address_Zipcode`) VALUES ('$tid','$city','$stateName','$address','$zip')";
