			...
			<td>
				<table>
					...
					<tr>
						...
						<td>
							<input type="text" name="price" placeholder="Price" pattern="[0-9]{1,10}" class="w3-input" required>
						</td>
					</tr>
					<tr align="center">
             		   <td colspan="2">
...
if (isset($_POST['create'])) {
	...
	$record = "INSERT INTO design_info (Tailor_id,Tailor_Org,Material_Name,Material_Color,Pattern_Type,Collar_Type,Sleeve_Type,Design_Price) VALUES('$tid','$org','$mname','$cname','$pattern','$collar','$sleeve','$price')";
