        ...
        <tr>
			<td>
				<table border = 1 class="table1">
					...
					$result = mysqli_query($con,"SELECT * FROM tailor_info JOIN design_info ON design_info.Tailor_id = tailor_info.Tailor_id WHERE design_info.Tailor_id = '$tid';");
					...
					while($res = mysqli_fetch_array($result)){
						...
						<td>
							<a href="placeOrder.php?id=<?php echo $did ?>&tid=<?php echo $tid ?>">Place order</a>
						</td>
                    	<?php
                    	echo "</tr>";
                    	$no+=1;						
