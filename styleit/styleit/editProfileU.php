        	...
        	<td>
        		<table class="table3">
                    ...
                    <tr>
                    	...
                    	<td>
                    		<input type="text" name="fname" id="fname" value="<?php echo $res['U_Name']; ?>" class="w3-input">
                    	</td>
                    	<td>
                    		Email:
                    	</td>
                    	<td>
                    		<input type="email" name="mail" id="mail" value="<?php echo $res['U_Email']; ?>" class="w3-input">
                    	</td>
                    </tr>
                    <tr>
                    	<td>
                    	...
                    	<td>
                    		<input type="text" name="fmono" id="fmono" maxlength="10" pattern="[0-9]{10}" class="w3-input" value="<?php echo $res['U_MobileNo']; ?>">
                    	</td>
                    </tr>
                    ...
                    <tr>	
                    	...
                    	<td>
                    		<input type="text" name="zip[]" id="zip" maxlength="6" pattern="[0-9]{6}" value="<?php echo $res['Address_Zipcode']; ?>" class="w3-input">
                    	</td>                   	
                    ...
                    <tr>
                    	...
                    	<td>
                    		<input type="text" name="uname" id="uname" value="<?php echo $res['U_userName']; ?>" class="w3-input">
                    	</td>
                    	<td align="center" colspan="2">
                    		<a href="changePasswordF.php?id=<?php echo $uid;?>" class="link1">Change Password</a>
                    	</td>
                    </tr>                    
        			<?php
                    }
...
if (isset($_POST['update'])) {
    ...
    $record = "UPDATE `user_info` SET `U_Name`='$fname',`U_MobileNo`='$fmono',`U_Email`='$mail',`U_userName`='$uname' WHERE U_id = '$uid'";
    $i = 0;
